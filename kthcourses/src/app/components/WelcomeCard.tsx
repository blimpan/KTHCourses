        ...
        <div className="default-comp-style !p-0 flex flex-col sm:flex-row  w-full h-full bg-white overflow-hidden">
            ...
            <div className="px-4 pt-4 sm:pb-4">
                ...
                <ul className="mt-4 space-y-2 font-semibold">
                    ...
                    <li className="flex items-center gap-2 text-nowrap"> <img src="/images/green-checkmark.svg" alt="Greenn checkmark" width={30} />Easy to use search tool</li>
            ...
            <div className="relative grow mt-2 overflow-hidden rounded-lg h-[10rem] xs:h-[15rem] sm:h-auto w-full">
                <img 
                    src="/images/kth-ellipse.webp" 
                    alt="KTH Logo"
                    className="absolute bottom-0 right-0 object-cover object-top top-0 h-[13rem] xs:h-[18rem] sm:object-right"
                />
            </div>
