...
export default function CourseCard(params) {
    ...
    return (
        <div onClick={onCardClick} className={`flex flex-col min-w h-min bg-white drop-shadow-md rounded-lg p-4 hover:-translate-y-0.5 transition-transform ease-in-out ${!params.searchPanelShowing ? 'cursor-pointer' : ''}`}>
